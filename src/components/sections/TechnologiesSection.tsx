...
const technologies = {
  frontend: [
    ...
    { name: 'jQuery', logo: 'https://jquery.com/jquery-wp-content/themes/jquery.com/i/favicon.ico' },
  ...
  backend: [
    ...
    { name: 'Dart', logo: 'https://dart.dev/assets/img/shared/dart/logo+text/horizontal/white.svg' },
    { name: 'Delphi', logo: 'https://www.embarcadero.com/images/logos/delphi-logo-128.png' }
  ],
  databases: [
    { name: 'SQL Server', logo: 'https://www.microsoft.com/en-us/sql-server/sql-server-downloads' },
    ...
    { name: 'Oracle', logo: 'https://www.oracle.com/a/ocom/img/dc/ft/oracle-db23c-badge.png' },
    ...
    { name: 'Firebase', logo: 'https://firebase.google.com/downloads/brand-guidelines/PNG/logo-built_white.png' },
  ...
  mobile: [
    ...
    { name: 'Java', logo: 'https://www.oracle.com/a/tech/img/cb88-java-logo-001.jpg' },
    { name: 'Xamarin', logo: 'https://raw.githubusercontent.com/xamarin/xamarin-android/main/Documentation/images/xamarin-android-logo.png' },
    { name: 'Ionic', logo: 'https://ionicframework.com/img/meta/logo.png' },
    { name: 'Unity', logo: 'https://unity.com/logo-unity-web.png' }
  ],
  analytics: [
    { name: 'Power BI', logo: 'https://powerbi.microsoft.com/pictures/application-logos/svg/powerbi.svg' },
    { name: 'Oracle BI', logo: 'https://www.oracle.com/a/ocom/img/bi-analytics.svg' },
    { name: 'SQL Server Reporting', logo: 'https://www.microsoft.com/en-us/sql-server/sql-server-downloads' },
